...
# Intel Image Classification — Simple CNN Tuning
...
This experiment showed that CNN tuning is not a fixed recipe. Adding more techniques does not always guarantee better performance.
